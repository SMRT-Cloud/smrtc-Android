...
import org.smartcloudj.crypto.KeyCrypter;
...
import global.smartcloud.DefaultCoinSelector;
...
public class SmartcloudModuleImp implements SmartcloudModule {

    private static final Logger logger = LoggerFactory.getLogger(SmartcloudModuleImp.class);
    ...
    public SmartcloudModuleImp(ContextWrapper contextWrapper, WalletConfiguration walletConfiguration,ContactsStoreDao contactsStore,RateDbDao rateDb,BackupHelper backupHelper) {
...
//    }
    ...
    public Transaction completeTxWithCustomFee(Transaction transaction,Coin fee) throws InsufficientMoneyException{
        ...
        walletManager.completeSend(sendRequest);
        // if the fee is different to the custom fee and the tx size is lower than 1kb (1000 bytes in smartcloud core)
...
//                    }
    ...
    public SmartcloudRate getRate(String coin) {
   ...
   public boolean isSyncWithNode() throws NoPeerConnectedException {
    ...
    @Override
    public List<SmartcloudRate> listRates() {
        return rateDb.list();
    }
    ...
    public void saveRate(SmartcloudRate smartcloudRate){
        rateDb.insertOrUpdateIfExist(smartcloudRate);
    }
