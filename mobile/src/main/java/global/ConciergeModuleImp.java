...
import global.concierge.DefaultCoinSelector;
...
public class ConciergeModuleImp implements ConciergeModule {

    private static final Logger logger = LoggerFactory.getLogger(ConciergeModuleImp.class);
    ...
    public ConciergeModuleImp(ContextWrapper contextWrapper, WalletConfiguration walletConfiguration,ContactsStoreDao contactsStore,RateDbDao rateDb,BackupHelper backupHelper) {
...
//    }
    ...
    public Transaction completeTxWithCustomFee(Transaction transaction,Coin fee) throws InsufficientMoneyException{
        ...
        walletManager.completeSend(sendRequest);
        // if the fee is different to the custom fee and the tx size is lower than 1kb (1000 bytes in concierge core)
...
//                    }
   ...
   public boolean isSyncWithNode() throws NoPeerConnectedException {
    ...
    @Override
    public List<ConciergeRate> listRates() {
        return rateDb.list();
    }
    ...
    public void saveRate(ConciergeRate conciergeRate){
        rateDb.insertOrUpdateIfExist(conciergeRate);
    }
