...
public class AquilaContext {
    ...
    /** Aquila wallet released time */
    public static final long Aquila_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME = 1500940800;
    ...
    public static final class Files{
        ...
        public static final String EXTERNAL_WALLET_BACKUP = "aquila-wallet-backup" +"_"+ FILENAME_NETWORK_SUFFIX;
