...
public class CoinMarketCapApiClient {
    ...
    public class AquilaMarket{
        ...
        public AquilaMarket(BigDecimal priceUsd, BigDecimal priceBtc, BigDecimal marketCapUsd, BigDecimal totalSupply, int rank) {
    ...
    public AquilaMarket getAquilaPxrice() throws RequestAquilaRateException{
        try {
            AquilaMarket aquilaMarket = null;
            String url = this.URL + "aqx";
            ...
            e.printStackTrace();
            throw new RequestAquilaRateException(e);
        } catch (IOException e) {
            e.printStackTrace();
            throw new RequestAquilaRateException(e);
    ...
    public static class BitPayApi {
         ...
         * @return
         * @throws RequestAquilaRateException
         */
        public <T> List<T> getRates(RatesConvertor<T> ratesConvertor) throws RequestAquilaRateException{
            try {
                HttpResponse httpResponse = get(URL);
                // receive response as inputStream
                InputStream inputStream = httpResponse.getEntity().getContent();
