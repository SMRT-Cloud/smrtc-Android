...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final AquilaApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (AquilaContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + AquilaContext.NETWORK_PARAMETERS.getId() + "\n");
		final Wallet wallet = ((AquilaModuleImp)application.getModule()).getWallet();
