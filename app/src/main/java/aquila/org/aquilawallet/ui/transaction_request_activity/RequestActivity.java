package aquila.org.aquilawallet.ui.transaction_request_activity;
...
import aquila.org.aquilawallet.ui.transaction_send_activity.AmountInputFragment;
import aquila.org.aquilawallet.utils.DialogsUtil;
import aquila.org.aquilawallet.utils.NavigationUtils;

import static android.graphics.Color.WHITE;
import static aquila.org.aquilawallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
import static aquila.org.aquilawallet.utils.QrUtils.encodeAsBitmap;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        addressStr = aquilaModule.getFreshNewAddress().toBase58();

        NetworkParameters params = aquilaModule.getConf().getNetworkParams();

        String aquilaURI = AquilaURI.convertToBitcoinURI(
                params,
                addressStr,
                amount,
        ...
        qrDialog = QrDialog.newInstance(aquilaURI);
        qrDialog.setQrText(aquilaURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        public static QrDialog newInstance(String aquilaURI) throws WriterException {
