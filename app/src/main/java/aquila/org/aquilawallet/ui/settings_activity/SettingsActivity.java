package aquila.org.aquilawallet.ui.settings_activity;
...
import aquila.org.aquilawallet.BuildConfig;
...
import aquila.org.aquilawallet.ui.export_account.ExportKeyActivity;
import aquila.org.aquilawallet.ui.import_watch_only.SettingsWatchOnly;
import aquila.org.aquilawallet.ui.restore_activity.RestoreActivity;
import aquila.org.aquilawallet.ui.settings_backup_activity.SettingsBackupActivity;
import aquila.org.aquilawallet.ui.settings_network_activity.SettingsNetworkActivity;
import aquila.org.aquilawallet.ui.settings_pincode_activity.SettingsPincodeActivity;
import aquila.org.aquilawallet.ui.settings_rates.SettingsRatesActivity;
import aquila.org.aquilawallet.ui.start_node_activity.StartNodeActivity;
import aquila.org.aquilawallet.ui.tutorial_activity.TutorialActivity;
import aquila.org.aquilawallet.utils.CrashReporter;
import aquila.org.aquilawallet.utils.DialogsUtil;
import aquila.org.aquilawallet.utils.IntentsUtils;
import aquila.org.aquilawallet.utils.NavigationUtils;
import aquila.org.aquilawallet.utils.ReportIssueDialogBuilder;
...
import static aquila.org.aquilawallet.ui.tutorial_activity.TutorialActivity.INTENT_EXTRA_INFO_TUTORIAL;
...
public class SettingsActivity extends BaseDrawerActivity implements View.OnClickListener {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        String text = "Made by<br> <font color=#55476c>MotoAcidic</font> <br>(c) AQX Community (c) PIVX Devs";
        ...
        text_rates.setText(aquilaApplication.getAppConf().getSelectedRateCoin());
        ...
        videoSwitch.setChecked(aquilaApplication.getAppConf().isSplashSoundEnabled());
        videoSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                aquilaApplication.getAppConf().setSplashSound(checked);
            }
        });
    }
    ...
    private void updateNetworkStatus() {
        ...
        txt_network_info.setText(
                Html.fromHtml(
                        "Network<br><font color=#55476c>"+aquilaModule.getConf().getNetworkParams().getId()+
                                "</font><br>" +
                                "Height<br><font color=#55476c>"+aquilaModule.getChainHeight()+"</font><br>" +
                                "Protocol Version<br><font color=#55476c>"+
                                aquilaModule.getProtocolVersion()+"</font>"
        ...
        SimpleTwoButtonsDialog dialog = DialogsUtil.buildSimpleTwoBtnsDialog(
                ...
                new SimpleTwoButtonsDialog.SimpleTwoBtnsDialogListener() {
                    ...
                    public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                        aquilaApplication.stopBlockchain();
    ...
    private void launchReportDialog() {
        ReportIssueDialogBuilder dialog = new ReportIssueDialogBuilder(
                this,
                "aquila.org.aquilawallet.myfileprovider",
                ...
                R.string.report_issue_dialog_message_issue)
        {
            ...
            protected CharSequence subject() {
                return AquilaContext.REPORT_SUBJECT_ISSUE+" "+aquilaApplication.getVersionName();
            }
            ...
            protected CharSequence collectApplicationInfo() throws IOException {
                ...
                CrashReporter.appendApplicationInfo(applicationInfo, aquilaApplication);
            ...
            protected CharSequence collectWalletDump() throws IOException {
                return ((AquilaModuleImp)aquilaModule).getWallet().toString(false,true,true,null);
            }
        };
        dialog.show();
    }
