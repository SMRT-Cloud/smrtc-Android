package aquila.org.aquilawallet.ui.crash_activity;
...
/**
 * Created by MotoAcidic on 8/18/17.
 */
...
public class CrashPopupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String authorities = "aquila.org.aquilawallet.myfileprovider";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        aquilaApplication.getAppConf().saveShowReportScreenOnStart(false);
    ...
    protected CharSequence subject(){
        return "Crash report"+" "+ aquilaApplication.getVersionName();
    }
    ...
    protected CharSequence collectWalletDump() throws IOException{
        return ((AquilaModuleImp)aquilaApplication.getModule()).getWallet().toString(false,true,true,null);
    }
}
