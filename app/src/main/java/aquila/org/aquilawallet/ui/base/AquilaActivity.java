...
import static aquila.org.aquilawallet.service.IntentsConstants.ACTION_STORED_BLOCKCHAIN_ERROR;
import static aquila.org.aquilawallet.service.IntentsConstants.ACTION_TRUSTED_PEER_CONNECTION_FAIL;

/**
 * Created by MotoAcidic on 6/8/17.
 */

public class AquilaActivity extends AppCompatActivity {

    protected AquilaApplication aquilaApplication;
    protected AquilaModule aquilaModule;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        aquilaModule = aquilaApplication.getModule();
