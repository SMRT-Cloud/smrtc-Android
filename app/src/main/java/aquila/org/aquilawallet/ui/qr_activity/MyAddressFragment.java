...
import static aquila.org.aquilawallet.utils.AndroidUtils.copyToClipboard;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(AquilaModule aquilaModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(aquilaModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = AquilaApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String aquilaUri = AquilaURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(aquilaUri,address.toBase58());
            }
    ...
    public void setModule(AquilaModule module) {
        this.module = module;
    }
