package aquila.org.aquilawallet.ui.donate;
...
/**
 * Created by MotoAcidic on 7/24/17.
 */
...
public class DonateActivity extends BaseDrawerActivity {
    ...
    private void send() {
        try {
            // create the tx
            String addressStr = AquilaContext.DONATE_ADDRESS;
            ...
            Transaction transaction = aquilaModule.buildSendTx(addressStr, amount, memo,aquilaModule.getReceiveAddress());
            // send it
            aquilaModule.commitTx(transaction);
            Intent intent = new Intent(DonateActivity.this, AquilaWalletService.class);
