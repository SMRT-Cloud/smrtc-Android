package aquila.org.aquilawallet.ui.export_account;
...
import aquila.org.aquilawallet.utils.AndroidUtils;
...
/**
 * Created by MotoAcidic on 8/29/17.
 */
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = aquilaModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(AquilaContext.NETWORK_PARAMETERS);
