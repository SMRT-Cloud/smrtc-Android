package aquila.org.aquilawallet.ui.import_watch_only;
...
import static aquila.org.aquilawallet.utils.CrashReporter.appendSavedBackgroundTraces;

/**
 * Created by MotoAcidic on 8/30/17.
 */
...
public class SettingsWatchOnly extends BaseActivity {
    ...
    private void importXpub() {
        ...
        if (xpub.length()>0){
            try {
                aquilaModule.watchOnlyMode(
                        xpub,
                        isBip32 ? DeterministicKeyChain.KeyChainType.BIP32: DeterministicKeyChain.KeyChainType.BIP44_AQX_ONLY
                );
