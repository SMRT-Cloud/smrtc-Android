package aquila.org.aquilawallet.ui.start_node_activity;
...
import aquila.org.aquilawallet.ui.pincode_activity.PincodeActivity;
import aquila.org.aquilawallet.ui.wallet_activity.WalletActivity;
import aquila.org.aquilawallet.utils.DialogBuilder;
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        findViewById(R.id.btn_default).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Check this..
                aquilaApplication.setTrustedServer(trustedNodes.get(3));
        ...
        btnSelectNode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isStarted = aquilaApplication.getAppConf().getTrustedNode()!=null;
                aquilaApplication.setTrustedServer(selectedNode);
        ...
        PivtrumPeerData pivtrumPeer = aquilaApplication.getAppConf().getTrustedNode();
