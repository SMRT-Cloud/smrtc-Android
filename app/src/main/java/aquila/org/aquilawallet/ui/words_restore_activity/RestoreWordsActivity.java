package aquila.org.aquilawallet.ui.words_restore_activity;
...
import aquila.org.aquilawallet.ui.transaction_send_activity.MyFilterableAdapter;
import aquila.org.aquilawallet.ui.transaction_send_activity.MyTextWatcher;
...
import static aquila.org.aquilawallet.module.AquilaContext.Aquila_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = aquilaModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            aquilaModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            aquilaModule.restoreWallet(mnemonic, Aquila_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (aquilaApplication.getAppConf().getPincode() != null){
                                                        // Check if the app is starting
                                                        if(!aquilaApplication.getAppConf().isAppInit()){
                                                            aquilaApplication.getAppConf().setAppInit(true);
                                                        }
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, AquilaContext.ENABLE_BIP44_APP_VERSION));
