package aquila.org.aquilawallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = aquilaModule.backupWallet(backupFile, firstPassword);

            if (result){
                aquilaApplication.getAppConf().setHasBackup(true);
