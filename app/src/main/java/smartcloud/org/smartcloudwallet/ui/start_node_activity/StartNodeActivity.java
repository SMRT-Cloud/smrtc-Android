package smartcloud.cash.smartcloudwallet.ui.start_node_activity;
...
import smartcloud.cash.smartcloudwallet.ui.pincode_activity.PincodeActivity;
import smartcloud.cash.smartcloudwallet.ui.wallet_activity.WalletActivity;
import smartcloud.cash.smartcloudwallet.utils.DialogBuilder;
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        findViewById(R.id.btn_default).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Check this..
                smartcloudApplication.setTrustedServer(trustedNodes.get(3));
        ...
        btnSelectNode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isStarted = smartcloudApplication.getAppConf().getTrustedNode() != null;
                smartcloudApplication.setTrustedServer(selectedNode);
        ...
        PivtrumPeerData pivtrumPeer = smartcloudApplication.getAppConf().getTrustedNode();
