package smartcloud.cash.smartcloudwallet.ui.export_account;
...
import smartcloud.cash.smartcloudwallet.utils.AndroidUtils;
...
/**
 * Created by Telostia on 8/29/17.
 */
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = smartcloudModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(SmartcloudContext.NETWORK_PARAMETERS);
