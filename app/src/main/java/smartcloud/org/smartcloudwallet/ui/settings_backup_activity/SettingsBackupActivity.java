package smartcloud.cash.smartcloudwallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = smartcloudModule.backupWallet(backupFile, firstPassword);

            if (result) {
                smartcloudApplication.getAppConf().setHasBackup(true);
