...
import static smartcloud.cash.smartcloudwallet.utils.AndroidUtils.copyToClipboard;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    private SmartcloudModule module;
    ...
    public static MyAddressFragment newInstance(SmartcloudModule smartcloudModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(smartcloudModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = SmartcloudApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String smartcloudUri = SmartcloudURI.convertToBitcoinURI(address, null, "Receive address", null);
                loadAddress(smartcloudUri, address.toBase58());
            }
    ...
    public void setModule(SmartcloudModule module) {
        this.module = module;
    }
