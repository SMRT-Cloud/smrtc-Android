package smartcloud.cash.smartcloudwallet.ui.splash_activity;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri video;
        if (SmartcloudApplication.getInstance().getAppConf().isSplashSoundEnabled())
    ...
    private void jump() {
        ...
        if (SmartcloudApplication.getInstance().getAppConf().isAppInit()) {
            Intent intent = new Intent(this, WalletActivity.class);
            startActivity(intent);
        } else {
