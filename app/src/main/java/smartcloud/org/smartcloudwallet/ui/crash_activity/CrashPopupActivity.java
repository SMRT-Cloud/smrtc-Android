package smartcloud.cash.smartcloudwallet.ui.crash_activity;
...
/**
 * Created by Telostia on 8/18/17.
 */
...
public class CrashPopupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String authorities = "smartcloud.cash.smartcloudwallet.myfileprovider";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        smartcloudApplication.getAppConf().saveShowReportScreenOnStart(false);
    ...
    protected CharSequence subject() {
        return "Crash report" + " " + smartcloudApplication.getVersionName();
    }
    ...
    protected CharSequence collectWalletDump() throws IOException {
        return ((SmartcloudModuleImp) smartcloudApplication.getModule()).getWallet().toString(false, true, true, null);
    }
}
