package smartcloud.cash.smartcloudwallet.ui.transaction_request_activity;
...
import smartcloud.cash.smartcloudwallet.ui.transaction_send_activity.AmountInputFragment;
...
import static smartcloud.cash.smartcloudwallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
import static smartcloud.cash.smartcloudwallet.utils.QrUtils.encodeAsBitmap;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        addressStr = smartcloudModule.getFreshNewAddress().toBase58();

        NetworkParameters params = smartcloudModule.getConf().getNetworkParams();

        String smartcloudURI = SmartcloudURI.convertToBitcoinURI(
                params,
                addressStr,
                amount,
        ...
        qrDialog = QrDialog.newInstance(smartcloudURI);
        qrDialog.setQrText(smartcloudURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        public static QrDialog newInstance(String smartcloudURI) throws WriterException {
