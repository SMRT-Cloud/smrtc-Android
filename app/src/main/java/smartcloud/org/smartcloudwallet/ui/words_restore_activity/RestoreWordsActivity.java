package smartcloud.cash.smartcloudwallet.ui.words_restore_activity;
...
import smartcloud.cash.smartcloudwallet.ui.transaction_send_activity.MyFilterableAdapter;
import smartcloud.cash.smartcloudwallet.ui.transaction_send_activity.MyTextWatcher;
...
import static smartcloud.cash.smartcloudwallet.module.SmartcloudContext.Smartcloud_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = smartcloudModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            smartcloudModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            smartcloudModule.restoreWallet(mnemonic, Smartcloud_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (smartcloudApplication.getAppConf().getPincode() != null){
                                                        // Check if the app is starting
                                                        if(!smartcloudApplication.getAppConf().isAppInit()){
                                                            smartcloudApplication.getAppConf().setAppInit(true);
                                                        }
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, SmartcloudContext.ENABLE_BIP44_APP_VERSION));
