package smartcloud.cash.smartcloudwallet.ui.donate;
...
/**
 * Created by Telostia on 7/24/17.
 */
...
public class DonateActivity extends BaseDrawerActivity {
    ...
    private void send() {
        try {
            // create the tx
            String addressStr = SmartcloudContext.DONATE_ADDRESS;
            ...
            Transaction transaction = smartcloudModule.buildSendTx(addressStr, amount, memo, smartcloudModule.getReceiveAddress());
            // send it
            smartcloudModule.commitTx(transaction);
            Intent intent = new Intent(DonateActivity.this, SmartcloudWalletService.class);
