package smartcloud.cash.smartcloudwallet.ui.import_watch_only;
...
import static smartcloud.cash.smartcloudwallet.utils.CrashReporter.appendSavedBackgroundTraces;

/**
 * Created by Telostia on 8/30/17.
 */
...
public class SettingsWatchOnly extends BaseActivity {
    ...
    private void importXpub() {
        ...
        if (xpub.length() > 0) {
            try {
                smartcloudModule.watchOnlyMode(
                        xpub,
                        isBip32 ? DeterministicKeyChain.KeyChainType.BIP32 : DeterministicKeyChain.KeyChainType.BIP44_SMRTC_ONLY
                );
