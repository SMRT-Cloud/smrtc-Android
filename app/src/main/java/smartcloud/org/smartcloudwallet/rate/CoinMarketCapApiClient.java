...
public class CoinMarketCapApiClient {
    ...
    private static final String URL = "http://smartcloud.cash/v1/";

    public class SmartcloudMarket {
        ...
        public SmartcloudMarket(BigDecimal priceUsd, BigDecimal priceBtc, BigDecimal marketCapUsd, BigDecimal totalSupply, int rank) {
    ...
    public SmartcloudMarket getSmartcloudPxrice() throws RequestSmartcloudRateException {
        try {
            SmartcloudMarket smartcloudMarket = null;
            String url = this.URL + "smrtc";
            ...
            if (httpResponse.getStatusLine().getStatusCode() == 200) {
                ...
                smartcloudMarket = new SmartcloudMarket(
            ...
            return smartcloudMarket;
        } catch (ClientProtocolException e) {
            e.printStackTrace();
            throw new RequestSmartcloudRateException(e);
        } catch (IOException e) {
            e.printStackTrace();
            throw new RequestSmartcloudRateException(e);
    ...
    public static class BitPayApi {
         ...
         *
         * @return
         * @throws RequestSmartcloudRateException
         */
        public <T> List<T> getRates(RatesConvertor<T> ratesConvertor) throws RequestSmartcloudRateException {
            try {
                HttpResponse httpResponse = get(URL);
                // receive response as inputStream
                InputStream inputStream = httpResponse.getEntity().getContent();
