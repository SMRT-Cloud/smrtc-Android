...
//	}
    ...
    public static void appendApplicationInfo(final Appendable report, final SmartcloudApplication application) throws IOException {
        ...
        report.append("Test/Prod: " + (SmartcloudContext.IS_TEST ? "test" : "prod") + "\n");
        ...
        report.append("Network: " + SmartcloudContext.NETWORK_PARAMETERS.getId() + "\n");
        final Wallet wallet = ((SmartcloudModuleImp) application.getModule()).getWallet();
