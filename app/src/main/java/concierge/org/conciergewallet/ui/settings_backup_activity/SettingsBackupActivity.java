package concierge.org.conciergewallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = conciergeModule.backupWallet(backupFile, firstPassword);

            if (result){
                conciergeApplication.getAppConf().setHasBackup(true);
