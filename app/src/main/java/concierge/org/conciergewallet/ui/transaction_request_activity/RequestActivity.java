package concierge.org.conciergewallet.ui.transaction_request_activity;
...
import concierge.org.conciergewallet.ui.transaction_send_activity.AmountInputFragment;
import concierge.org.conciergewallet.utils.DialogsUtil;
import concierge.org.conciergewallet.utils.NavigationUtils;

import static android.graphics.Color.WHITE;
import static concierge.org.conciergewallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        addressStr = conciergeModule.getFreshNewAddress().toBase58();
        ...
        qrDialog = QrDialog.newInstance(conciergeURI);
        qrDialog.setQrText(conciergeURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        public static QrDialog newInstance(String conciergeURI) throws WriterException {
