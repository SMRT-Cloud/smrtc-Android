package concierge.org.conciergewallet.ui.settings_activity;
...
import concierge.org.conciergewallet.ui.import_watch_only.SettingsWatchOnly;
import concierge.org.conciergewallet.ui.restore_activity.RestoreActivity;
import concierge.org.conciergewallet.ui.settings_backup_activity.SettingsBackupActivity;
import concierge.org.conciergewallet.ui.settings_network_activity.SettingsNetworkActivity;
import concierge.org.conciergewallet.ui.settings_pincode_activity.SettingsPincodeActivity;
import concierge.org.conciergewallet.ui.settings_rates.SettingsRatesActivity;
import concierge.org.conciergewallet.ui.start_node_activity.StartNodeActivity;
import concierge.org.conciergewallet.ui.tutorial_activity.TutorialActivity;
import concierge.org.conciergewallet.utils.CrashReporter;
import concierge.org.conciergewallet.utils.DialogsUtil;
import concierge.org.conciergewallet.utils.IntentsUtils;
import concierge.org.conciergewallet.utils.NavigationUtils;
import concierge.org.conciergewallet.utils.ReportIssueDialogBuilder;
...
import static concierge.org.conciergewallet.ui.tutorial_activity.TutorialActivity.INTENT_EXTRA_INFO_TUTORIAL;
...
public class SettingsActivity extends BaseDrawerActivity implements View.OnClickListener {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        String text = "Made by<br> <font color=#55476c>akshaynexus</font> <br>(c) CCC Community (c) PIVX Devs";
        ...
        text_rates.setText(conciergeApplication.getAppConf().getSelectedRateCoin());
        ...
        videoSwitch.setChecked(conciergeApplication.getAppConf().isSplashSoundEnabled());
        videoSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                conciergeApplication.getAppConf().setSplashSound(checked);
            }
        });
    }
    ...
    private void updateNetworkStatus() {
        ...
        txt_network_info.setText(
                Html.fromHtml(
                        "Network<br><font color=#55476c>"+conciergeModule.getConf().getNetworkParams().getId()+
                                "</font><br>" +
                                "Height<br><font color=#55476c>"+conciergeModule.getChainHeight()+"</font><br>" +
                                "Protocol Version<br><font color=#55476c>"+
                                conciergeModule.getProtocolVersion()+"</font>"
    ...
    private void launchReportDialog() {
        ReportIssueDialogBuilder dialog = new ReportIssueDialogBuilder(
                this,
                "concierge.org.conciergewallet.myfileprovider",
                ...
                R.string.report_issue_dialog_message_issue)
        {
            ...
            protected CharSequence collectApplicationInfo() throws IOException {
                ...
                CrashReporter.appendApplicationInfo(applicationInfo, conciergeApplication);
