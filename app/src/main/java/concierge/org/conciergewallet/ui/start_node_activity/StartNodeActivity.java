package concierge.org.conciergewallet.ui.start_node_activity;
...
import concierge.org.conciergewallet.utils.DialogBuilder;
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        btnSelectNode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isStarted = conciergeApplication.getAppConf().getTrustedNode()!=null;
                conciergeApplication.setTrustedServer(selectedNode);
        ...
        PivtrumPeerData pivtrumPeer = conciergeApplication.getAppConf().getTrustedNode();
