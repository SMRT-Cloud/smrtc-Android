package concierge.org.conciergewallet.ui.words_restore_activity;
...
import concierge.org.conciergewallet.ui.transaction_send_activity.MyFilterableAdapter;
import concierge.org.conciergewallet.ui.transaction_send_activity.MyTextWatcher;
...
import static concierge.org.conciergewallet.module.ConciergeContext.Concierge_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = conciergeModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            conciergeModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            conciergeModule.restoreWallet(mnemonic, Concierge_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (conciergeApplication.getAppConf().getPincode() != null){
                                                        // Check if the app is starting
                                                        if(!conciergeApplication.getAppConf().isAppInit()){
                                                            conciergeApplication.getAppConf().setAppInit(true);
                                                        }
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, ConciergeContext.ENABLE_BIP44_APP_VERSION));
