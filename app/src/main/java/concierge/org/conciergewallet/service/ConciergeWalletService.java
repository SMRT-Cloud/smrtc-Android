...
import org.conciergej.core.Block;
import org.conciergej.core.Coin;
import org.conciergej.core.FilteredBlock;
import org.conciergej.core.Peer;
import org.conciergej.core.Transaction;
import org.conciergej.core.TransactionConfidence;
import org.conciergej.core.listeners.AbstractPeerDataEventListener;
...
import static concierge.org.conciergewallet.service.IntentsConstants.ACTION_SCHEDULE_SERVICE;
...
import static concierge.org.conciergewallet.service.IntentsConstants.NOT_BLOCKCHAIN_ALERT;
...
public class ConciergeWalletService extends Service{
        ...
        public void onBlocksDownloaded(final Peer peer, final Block block, final FilteredBlock filteredBlock, final int blocksLeft) {
            ...
            /*if (ConciergeContext.IS_TEST)
                ...
                if (now - lastMessageTime > TimeUnit.SECONDS.toMillis(6)) {
                    ...
                    conciergeApplication.getAppConf().setLastBestChainBlockTime(block.getTime().getTime());
    ...
    private WalletCoinsReceivedEventListener coinReceiverListener = new WalletCoinsReceivedEventListener() {
        ...
        public void onCoinsReceived(Wallet wallet, Transaction transaction, Coin coin, Coin coin1) {
            ...
            org.conciergej.core.Context.propagate(CONTEXT);
    ...
    public void onCreate() {
        ...
        super.onCreate();
        try {
            log.info("Concierge service started");
            // Android stuff
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        log.info("Concierge service onStartCommand");
        try {
            if (intent != null) {
                try {
